    ...
    *,
    ...
    try:
        response = await provider.complete(
            ...
            prompt=prompt,
            # Gemini 3 spends most of this budget on internal reasoning before
            # writing anything: a measured call used 671 thinking tokens to
            # produce 148 tokens of answer. 2000 leaves room for a full
            # explanation while keeping the round trip inside the serverless
            # function timeout, which a 3000-token answer could exceed.
            max_tokens=2000,
            temperature=0.6,
        )
